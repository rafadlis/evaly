  ...
  async run() {
    new sst.aws.Nextjs("MainWebsite", {
      ...
      environment: {
        ...
        AWS_ACCESS_KEY_ID: new sst.Secret("AWS_ACCESS_KEY_ID").value,
        AWS_SECRET_ACCESS_KEY: new sst.Secret("AWS_SECRET_ACCESS_KEY").value,
        AWS_REGION: new sst.Secret("AWS_REGION").value,
