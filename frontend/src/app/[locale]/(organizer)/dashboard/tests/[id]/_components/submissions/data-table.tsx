...
export function DataTable<TData, TValue>({
    ...
    const initialSorting: SortingState = sortColumn && sortDirection 
    ...
    const handleSortingChange: OnChangeFn<SortingState> = (updaterOrValue) => {
        ...
        if (onSortingChange) {
            ...
            const direction = updatedSorting.length > 0 
                ? (updatedSorting[0].desc ? 'desc' : 'asc') 
                : '';
    ...
    const handlePaginationChange: OnChangeFn<PaginationState> = (updaterOrValue) => {
        // Handle both function updater and direct value
        const updatedPagination = typeof updaterOrValue === 'function'
